...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__generic_list__ = __webpack_require__("../../../../../src/app/generic-list.ts");
...
var AppComponent = (function () {
    function AppComponent(_appService) {
        ...
        this.list = new __WEBPACK_IMPORTED_MODULE_2__generic_list__["a" /* GenericList */]();
    }
    AppComponent.prototype.ngOnInit = function () {
        ...
        // });
        var _this = this;
        this._appService.listHQBuildsAsObservable().subscribe(function (result) {
            _this.hqBuilds = result;
        });
        this._appService.listFLBuildsAsObservable().subscribe(function (result) {
...
var AppService = (function () {
    ...
    AppService.prototype.sayHello = function () {
        var url = this.localUrl + "/hello";
        return this._http.get(this.localUrl).map(function (response) {
            return response.text();
        });
    };
    AppService.prototype.listHQBuildsAsObservable = function () {
        var url = this.localUrl + "/hqbuilds";
        return this._http.get(url).map(function (response) { return response.json(); });
    };
    AppService.prototype.listFLBuildsAsObservable = function () {
        var url = this.localUrl + "/flbuilds";
        return this._http.get(url).map(function (response) { return response.json(); });
    };
    return AppService;
}());
...
/***/ "../../../../../src/app/generic-list.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GenericList; });
